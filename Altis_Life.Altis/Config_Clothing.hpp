...
class Clothing {
    class bruce {
        ...
        uniforms[] = {
            ...
            { "U_C_Poloshirt_blue", "Poloshirt Land", 250, { "", "", -1 } },
			{ "U_C_Poloshirt_burgundy", "", 250, { "", "", -1 } },
			{ "U_C_Poor_1", "", 250, { "", "", -1 } },
			{ "U_IG_Guerilla2_2", "", 650, { "", "", -1 } },			
			{ "U_IG_Guerilla3_1", "", 650, { "", "", -1 } },
			{ "U_IG_Guerilla2_3", "", 1200, { "", "", -1 } },
			{ "U_IG_Guerilla2_1", "", 1200, { "", "", -1 } },
			{ "U_IG_Guerilla3_2", "", 5000, { "", "", -1 } },
			{ "U_B_SpecopsUniform_sgg", "", 5000, { "", "", -1 } },
			{ "U_C_HunterBody_grn", "", 1500, { "", "", -1 } },
			{ "U_OrestesBody", "", 2000, { "", "", -1 } },			
			{ "U_I_G_Story_Protagonist_F", "", 1500, { "", "", -1 } },
			{ "U_I_G_resistanceLeader_F", "", 10000, { "", "", -1 } },
			{ "U_Competitor", "", 2000, { "", "", -1 } },
			{ "U_C_Journalist", "", 5000, { "", "", -1 } },			
			{ "U_Marshal", "", 2500, { "", "", -1 } },
			{ "U_NikosBody", "", 5000, { "", "", -1 } },			
			{ "U_NikosAgedBody", "", 10000, { "", "", -1 } },
			{ "U_C_Scientist","", 20000, {"","",-1} }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
            { "H_Bandanna_camo", "", 150, { "", "", -1 } },
			{ "H_Bandanna_surfer", "", 1500, { "", "", -1 } },
    ...
    class cop {
        ...
        uniforms[] = {
			...
			{ "U_B_CombatUniform_mcam", "", 100, { "", "", -1 } },
			{ "U_B_SpecopsUniform_sgg", "", 1000, { "life_coplevel", "SCALAR", 4 } },
			{ "U_B_CTRG_3", "", 500, { "life_coplevel", "SCALAR", 7 } },
			{ "U_I_CombatUniform_shortsleeve", "", 500, { "license_cop_sek", "BOOL", true } },
			{ "U_MillerBody", "", 500, { "life_coplevel", "SCALAR", 6 } },
			{ "U_B_CombatUniform_mcam_worn", "", 500, { "life_coplevel", "SCALAR", 8 } },
			{ "U_O_Wetsuit", "", 550, { "life_coplevel", "SCALAR", 4} },
			{ "U_B_GhillieSuit", "", 550, { "license_cop_kripo", "BOOL", true } },
			{ "U_I_pilotCoveralls", "", 550, { "license_cop_kripo", "BOOL", true } },
		    { "U_NikosAgedBody", "", 550, { "license_cop_kripo", "BOOL", true } },
			{ "U_B_FullGhillie_sard", "", 550, { "license_cop_kripo", "BOOL", true } },
			{ "U_IG_Guerilla3_2", "", 550, { "license_cop_kripo", "BOOL", true } },
			{ "U_IG_Guerilla3_1", "", 1250, { "license_cop_kripo", "BOOL", true } },
			{ "U_O_CombatUniform_oucamo", "", 1250, { "license_cop_kripo", "BOOL", true } },
			{ "U_O_PilotCoveralls",  "", 1250, { "license_cop_kripo", "BOOL", true } },
			{ "U_IG_Guerilla2_3", "", 1250, { "license_cop_kripo", "BOOL", true } },
			{ "U_I_CombatUniform_tshirt", "", 1250,{ "license_cop_kripo", "BOOL", true } },
        ...
        headgear[] = {
            ...
            { "H_Watchcap_blk", "", 75, { "life_coplevel", "SCALAR", 4 } },
            { "H_MilCap_mcamo", "", 75, { "life_coplevel", "SCALAR",5 } },
            { "H_Booniehat_indp", "", 75, { "life_coplevel", "SCALAR", 6 } },
            { "H_Beret_02", "", 75, { "life_coplevel", "SCALAR", 8 } },
            { "H_CrewHelmetHeli_B", "", 75, { "life_coplevel", "SCALAR", 8 } },
            { "H_PilotHelmetHeli_B", "", 75, { "life_coplevel", "SCALAR", 8 } },
            { "H_PilotHelmetHeli_B", "", 75, { "life_coplevel", "SCALAR", 8 } },
            { "H_HelmetB_light", "", 75, { "life_coplevel", "SCALAR", 8 } },
            { "H_HelmetB_light_black", "", 75, { "life_coplevel", "SCALAR", 8 } },
            //HELII SEK/Kripo
			{ "H_HelmetB_black", "", 75, { "license_cop_sek", "BOOL", true } },
			{ "H_HelmetB_black", "", 75, { "license_cop_sek", "BOOL", true } },
			{ "H_CrewHelmetHeli_B", "", 75, { "license_cop_sek", "BOOL", true } },
            { "H_Beret_Colonel", "", 75, { "life_coplevel", "SCALAR", 8 } }
        };
        goggles[] = {
            { "NONE", "Remove Glasses", 0, { "", "", -1 } },
			...
			{ "G_Balaclava_oli", "", 75, { "license_cop_kripo", "BOOL", true } },
            { "G_Diving", "", 5000, { "", "", -1 } }
        };
        vests[] = {
            { "NONE", "Remove Vest", 0, { "", "", -1 } },
			...
			{ "V_PlateCarrier1_blk", "", 80000, { "life_coplevel", "SCALAR", 4 } },
            ...
            { "V_RebreatherB", "", 20000, { "life_coplevel", "SCALAR", 3 } },
			{ "V_PlateCarrierH_CTRG", "", 2000, { "license_cop_sek", "BOOL", true } },
			{ "V_PlateCarrierGL_rgr", "", 20000, { "license_cop_sek", "Bool", true } }
        };
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, { "", "", -1 } },
            { "B_Kitbag_cbr", "", 800, { "", "", -1 } },
    ...
    class reb {
        ...
        uniforms[] = {
			...
			{ "U_B_SpecopsUniform_sgg", "", 20000, { "", "", -1 } },
