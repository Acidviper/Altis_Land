    ...
    */
    ...
    class cop_car {
        ...
        vehicles[] = {
			...
			{ "I_MRAP_03_hmg_F", { "life_coplevel", "SCALAR", 7 } },
			//Kripo Car
...
*/
    ...
    class B_Quadbike_01_F {
        ...
        textures[] = {
			...
			{ "MTD", "med", {
                "textures\mtd\fahrzeuge\mtd_quadbike.paa"
            } }
        };
    };
    ...
    class B_MRAP_01_F {
     ...
     class B_Heli_Light_01_stripped_F {
        ...
        textures[] = {
			...
			{ "Rebelle Lackierung", "reb", {
				"textures\civi\fahrzeuge\hum\reb_helilight.paa"
            } }
        };
    };
    ...
    class C_Heli_Light_01_civil_F {
		...
		textures[] = {
			...
			{ "Speedy", "civ", {
                "textures\civi\fahrzeuge\hum\heli_civspeedy.paa"
            } }
		};	
    };
