...
_action = [
	"Uwaga, za chwile zostaniesz przewieziony na zawrotną wysokośc (koszt: € 125`000), kontynuować?",
	"Skydiving",
	"Tak",
	"Nie"
...
if(_action) then {
	...
	if (isNull _heli) then {
		...
		_heli setObjectTextureGlobal [0,"textures\civi\fahrzeuge\huron\CIV_Huron0.paa"];
		_heli setObjectTextureGlobal [1,"textures\civi\fahrzeuge\huron\CIV_Huron1.paa"];
