...
switch (life_adminwarning) do
{
	case 0:
	{
		hint "Guten Tag, ein Admin bittet Sie darum sich auf Teamspeak3 einzufinden. IP: ts3.altisland.pl Channel: Warte Support Altis Life. Dies ist Ihre erste Warnung!";
