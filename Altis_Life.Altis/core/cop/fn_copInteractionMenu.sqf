...
if(!((player distance (getMarkerPos "police_hq_1") < 80) OR  (player distance (getMarkerPos "police_hq_2") < 80) OR (player distance (getMarkerPos "cop_spawn_3") < 50)OR (player distance (getMarkerPos "jail_mark_3") < 80) OR (player distance (getMarkerPos "cop_spawn_5_1") < 80))) then  {
