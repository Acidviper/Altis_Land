...
if(isNil "_data") exitWith {hint "Kriminalaufzählung fehlgeschlagen";};
if(typeName _data != "ARRAY") exitWith {hint "Kriminalaufzählung fehlgeschlagen";};
if(count _data == 0) exitWith {hint "Kriminalaufzählung fehlgeschlagen";};
lbClear _list;
