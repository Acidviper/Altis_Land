...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","copper_mine","iron_mine","salt_mine","sand_mine","diamond_mine","oil_field_1","oil_field_2","rock_quarry"];
_zone = "";
