                        ...
                        if (ctrlText ((findDisplay 63) displayCtrl 101) == "Side Channel") then
                        {
                                ...
                                if (disconnect_me == 0) then {
                                        if (isNil "warn_one") then {
                                                warn_one = true;
                                                systemChat ("Proszę nie mówić w Side Chat! pierwsze ostrzeżenie!");
                                                [] spawn DS_slap_them;
												playSound "flashbang";
                                                
                                                ["Proszę nie mówić w Side Chat! pierwsze ostrzeżenie!"] spawn DS_double_cut;
                                        };
                                };
								 ...
								 if (disconnect_me == 1) then {
                                        if (isNil "warn_two") then {
                                                warn_two = true;
                                                systemChat ("Proszę nie mówić w Side Chat! drugie ostrzeżenie!");
                                                [] spawn DS_slap_them;
												playSound "flashbang";
                                                
                                                ["Proszę nie mówić w Side Chat! drugie ostrzeżenie!"] spawn DS_double_cut;
                                        };
                                };
								...
								if (disconnect_me == 2) then {
										if (isNil "warn_three") then {
												warn_three = true;
												systemChat ("Proszę nie mówić w Side Chat! Ostatnie ostrzeżenie inaczej kick");
												[] spawn DS_slap_them;
												playSound "flashbang";
												["Proszę nie mówić w Side Chat! Ostatnie ostrzeżenie inaczej kick"] spawn DS_double_cut;
										};
								};
                                ...
                                if (disconnect_me >= 2) then {
                                        if (isNil "warn_last") then {
                                                ...
                                                ["Ostrzegałem!"] spawn DS_double_cut;
                                                1 fadeMusic 10;
                                                1 fadeSound 10;
                                                ...
                                                endMission "Sidechat tylko pisanie Tobie pozostało!";
                                        };
                                };
                        };
                };
